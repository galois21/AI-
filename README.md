...
### 1.2 苹果电脑（macOS）
备注：如果是M系列cpu，可以直接在mac的App Store 内下载小火箭即可，通用。
...
- 其他购买：[https://store.sorryios.com](https://store.sorryios.com)
...
## 6 启动银行 app 出现“检测存在代理”，强制退出的问题分析和解决
   **相关分析**：https://community.nssurge.com/d/2142-surge-ios-app
   **解决思路**：一般梯子默认 是 http 代理+虚拟网卡代理，但 http 会被银行app 通过系统接口识别检测，然后拒绝服务。所以只需要调整到仅虚拟网卡模式即可，代价是对设备消耗变大，速度变慢
   **解决办法**：以小火箭Shadowrocket为例， 设置-代理-代理类型里的“HTTP”改为“None/TUN Mode”即可。https://v2ex.com/t/1000228
